...
export function TrustFeatures() {
  return (
    <div className="relative z-10 mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-10   gap-y-6 px-4 pb-16 pt-24 sm:pt-12 md:pb-20 divide-x divide-slate-200">
      {FEATURES.map(({ label, icon: Icon }) => (
        <div key={label} className="flex flex-col items-center gap-6 px-12">
