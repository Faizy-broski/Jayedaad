    ...
    <div className="flex flex-col gap-4 rounded-3xl border border-border bg-card p-5 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="flex min-w-0 flex-col">
          <span className="truncate text-sm font-semibold text-foreground">{developer.name}</span>
          <span className="truncate text-xs text-muted-foreground">{developer.city}</span>
        </div>
      </div>
      ...
      <p className="text-xs leading-relaxed text-muted-foreground">{developer.description}</p>
