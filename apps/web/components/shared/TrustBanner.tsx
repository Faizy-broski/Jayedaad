...
interface TrustBannerProps {
  /** Defaults to the dusk-villa shot used on About Us / Services. */
  backgroundImage?: string;
}

// Shared "Trust isn't promised. It's verified." banner — identical copy and
// feature set on both About Us and Services, so it lives here rather than
// being duplicated per page. Only the background photo is swappable.
export function TrustBanner({ backgroundImage = '/images/about-us/trusted.jpg' }: TrustBannerProps) {
  return (
