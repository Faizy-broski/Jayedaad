...
export function AgencyDetailSection({ slug }: AgencyDetailSectionProps) {
  ...
  if (isLoading) {
    return <div className="py-32 text-center text-sm text-muted-foreground">Loading agency…</div>;
  }

  if (error || !agency) {
    return (
      <div className="flex flex-col items-center gap-3 py-32 text-center">
        <p className="text-sm text-muted-foreground">This agency couldn&apos;t be found — it may have been removed.</p>
