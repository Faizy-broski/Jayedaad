          ...
          return (
            ...
            >
              ...
              <div className={imageFirst ? 'order-2' : 'order-2 sm:order-1'}>
                <span className="text-[11px] font-semibold uppercase tracking-widest text-eyebrow-gradient">
                  {service.tag}
                </span>
                <h3 className="mt-2 py-2 text-2xl font-bold leading-tight text-heading-gradient sm:text-3xl">
                  {service.title}
                </h3>
