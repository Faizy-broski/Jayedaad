              ...
              {featured && (
                <Reveal className="mb-10">
                  <Link
                    ...
                    className="group grid grid-cols-1 overflow-hidden rounded-2xl border border-border bg-card shadow-sm transition-shadow hover:shadow-lg lg:grid-cols-2"
                  >
                    ...
                    <div className="flex flex-col justify-center gap-3 p-6 sm:p-8">
                      ...
                      <h2 className="text-2xl font-bold leading-snug text-foreground sm:text-3xl">{featured.title}</h2>
                      {featured.excerpt && <p className="line-clamp-3 text-sm text-muted-foreground sm:text-base">{featured.excerpt}</p>}
